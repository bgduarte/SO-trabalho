...
inline Thread::Thread(void (* entry)(Tn ...), Tn ... an) {
    ...
    /*
     * como as threads sao criadas de maneira sequencial, 
     * por enquanto nao ha necessidade de proteger com um mutex
     */ 
    _id = _increment_thread_counter();
}
